...
// Middleware
app.use(cors({
  origin: ['http://localhost:3000','https://ecommercefrontend-henna.vercel.app','https://ecommercebackend-topaz.vercel.app', 'http://localhost:3001', 'https://merabestie.com', 'https://hosteecommerce.vercel.app'],
  credentials: true, // Allow credentials (cookies, HTTP authentication, etc.)
  methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'], // Allowed HTTP methods
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Requested-With'], // Allowed headers
  preflightContinue: true, // Ensures preflight requests are properly handled
}));
